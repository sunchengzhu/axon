...
* fix: check mempool when call `eth_getTransactionByHash` by @yangby-cryptape in ([\#1526](https://github.com/axonweb3/axon/pull/1526))
* fix: use a same default value for `max_payload_size` by @yangby-cryptape in ([\#1548](https://github.com/axonweb3/axon/pull/1548))
...
* fix: field `chainId` should be acceptable for `eth_estimateGas` by @yangby-cryptape in ([\#1601](https://github.com/axonweb3/axon/pull/1601))
* fix: enable estimation mode for query apis by @yangby-cryptape in ([\#1603](https://github.com/axonweb3/axon/pull/1603))
* fix: get pending tx count by number ([\#1605](https://github.com/axonweb3/axon/pull/1605))
* fix: duplicated calculation in `eth_estimateGas` by @yangby-cryptape in ([\#1599](https://github.com/axonweb3/axon/pull/1599), [\#1609](https://github.com/axonweb3/axon/pull/1609))
...
* Remove empty crates by @yangby-cryptape in ([\#1521](https://github.com/axonweb3/axon/pull/1521))
...
* Remove duplicated code to protect by @yangby-cryptape in ([\#1556](https://github.com/axonweb3/axon/pull/1556))
...
* ci: run unit tests in separate processes by @yangby-cryptape in ([\#1559](https://github.com/axonweb3/axon/pull/1559))
